                    ...
                    <div className='grow'>
                        ...
                        <div className='flex gap-20'>
                            <div className='space-y-4'>
                                ...
                                <div>
                                    <p className='text-4xl font-extrabold'>{searchedFromApps.downloads}</p>
                                </div>
                            </div>
                            <div className='space-y-4'>
                        ...
                        <button className='btn btn-accent my-6'>Install Now (291 MB)</button>
                    </div>
                </div>
                <div className="divider"></div>
